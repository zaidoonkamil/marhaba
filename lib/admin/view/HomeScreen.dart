                        ...
                        child: Column(
                          children: [
                            ...
                            CardHome(
                              ...
                              title: 'احجــز رحلاتــك\nاقامــة فاخــرة\nجولات مميزة',
                              desc: 'اكتشف وجهات مذهلة وتجارب لاتُنسى نوفر لك كل ما تحتاجه لجعل رحلاتك أسهل وأمتع أينما كنت',
                              color: Color(0XFF20BCFF),
                              image: 'assets/images/Rectangle 28 (3).png',
                              color2:  Color(0XFF12DF97),
                            ),
                            CardHome(
                              onTap: (){
                                navigateTo(context, Booking(
